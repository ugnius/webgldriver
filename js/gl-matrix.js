...
var glMatrixArrayType = null;
var MatrixArray = null;


if ( typeof(Float32Array) !== undefined ) {
    glMatrixArrayType = MatrixArray = Float32Array;
} else {
    glMatrixArrayType = MatrixArray = Array;
}
 ...
 * @param {vec3=} opt_vec vec3 containing values to initialize with
 *
 * @returns {vec3} New vec3
 */
vec3.create = function (opt_vec) {
    var dest = new MatrixArray(3);

    if (opt_vec === undefined) {
